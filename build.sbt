...
val scala30  = "3.0.2"   // up to 3.0.2 // not yet working
...
libraryDependencies ++= {
  val scalaXmlVersion = CrossVersion.partialVersion(scalaVersion.value) match {
    case Some((2, _)) => "1.3.1"
    // What kind of 2.13 versions are there?
    case Some((3, 0)) => "2.2.0"
    case Some((3, _)) => "2.2.0" // uses scala3-library_3 version 3.0.1
    case _ => ???
  }
  ...
  Seq(
    ...
    "org.scala-lang.modules" %% "scala-xml" % scalaXmlVersion // OK for scala 2.11, 2.12
  )
}
